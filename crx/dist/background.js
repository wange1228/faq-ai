...
var focusOrCreateTab = exports.focusOrCreateTab = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(url) {
    var wins, existTab, _existTab, tabId;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            wins.forEach(function (_ref2) {
              var _ref2$tabs = _ref2.tabs,
                  tabs = _ref2$tabs === undefined ? [] : _ref2$tabs;
            ...
            _existTab = existTab, tabId = _existTab.id;
...
var _windows = __webpack_require__(85);
...
function getBindings() {
  return _storage2.default.get('bindings');
}

function getDomain(url) {
  var reg = /chrome-extension|https?:\/\/([^/]+):?\d*\/?/;
...
exports.default = {
  update: function update(tabId, updateProperties, cb) {
    chrome.tabs.update(tabId, updateProperties, cb);
  },
  reload: function reload(tabId, updateProperties, cb) {
    chrome.tabs.reload(tabId, updateProperties, cb);
  },
  create: function create(createProperties, cb) {
...
var _browserAction = __webpack_require__(92);

var _browserAction2 = _interopRequireDefault(_browserAction);

var _helper = __webpack_require__(73);
...
function startListening() {
  _browserAction2.default.onClicked = function (tab) {
    var url = chrome.extension.getURL('cddh.html');

    (0, _helper.focusOrCreateTab)(url);
  };

  _runtime2.default.onMessage = function (_ref) {
    var type = _ref.type,
        _ref$params = _ref.params;
    _ref$params = _ref$params === undefined ? {} : _ref$params;
    var problem = _ref$params.problem,
        options = _ref$params.options,
        _ref$option = _ref.option,
        option = _ref$option === undefined ? '' : _ref$option,
        _ref$num = _ref.num,
        num = _ref$num === undefined ? '' : _ref$num;

    if (type === 'search') {
      if (tmpProblem !== problem) {
        var url = 'https://www.baidu.com/s?ie=utf-8&wd=' + encodeURIComponent(problem);
        (0, _helper.focusOrCreateTab)(url);
        tmpProblem = problem;
      }
    }
    if (type === 'answer') {
      var _url = 'chrome-extension://hbhjajefdgijidafmbmdfhnkeekjnlcn/cddh.html';
      (0, _helper.focusOrCreateTab)(_url);
    }
  };
}
