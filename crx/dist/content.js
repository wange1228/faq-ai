...
(0, _jquery2.default)(function () {
  var reg = /(\d+,?)+/;
  if ((0, _jquery2.default)('#wrapper_wrapper .nums') && (0, _jquery2.default)('#wrapper_wrapper .nums')[0]) {
    var params = (0, _helper.getParams)();
    var wd = params.wd;
    var match = /(.+)\s+\+?(.+)/;
    var option = match.exec(decodeURIComponent(wd))[2];
    var num = reg.exec((0, _jquery2.default)('#wrapper_wrapper .nums')[0].innerText)[0];
