...
var _runtime = __webpack_require__(72);

var _runtime2 = _interopRequireDefault(_runtime);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var url = 'http://htpmsg.jiecaojingxuan.com/msg/current'; //
//
//
//
//
...
exports.default = {
  ...
  methods: {
    handleStartListening: function handleStartListening() {
      var _this = this;
      ...
      if (this.isListening) {
        this.loop = setInterval(function () {
          _this.queryQuestion().then(function (res) {
            if (res.data && res.data.event) {
              var _ref = res.data.event || {},
                  desc = _ref.desc,
              ...
              if (_this.problem !== _this.tmpProblem) {
                _this.queryFaqAi({
                  question: _this.problem.replace(/\d+./, ''),
                  optionA: options[0],
                  optionB: options[1],
                  optionC: options[2]
                }).then(function (res) {
                ...
                _this.tmpProblem = _this.problem;
              }
              _runtime2.default.sendMessage({
                type: 'search',
                params: {
    ...
    queryQuestion: function queryQuestion() {
    ...
    queryFaqAi: function queryFaqAi(data) {
      return new _promise2.default(function (resolve, reject) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(88), __webpack_require__(89), __webpack_require__(98).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(89), __webpack_require__(88)))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue__ = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2aca26d0_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(102);
var disposed = false
var normalizeComponent = __webpack_require__(101)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2aca26d0_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\cddh\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2aca26d0", Component.options)
  } else {
    hotAPI.reload("data-v-2aca26d0", Component.options)
  }
...
var render = function() {
  ...
  return _c("div", { staticStyle: { "font-size": "20px" } }, [
    _c("button", { on: { click: _vm.handleStartListening } }, [
      _vm._v(_vm._s(_vm.isListening ? "停止" : "开始"))
    ]),
    _c("div", [_vm._v(_vm._s(_vm.problem))]),
    _c(
      "ul",
    ...
    _c(
      ...
      _vm._l(_vm.answers, function(item, index) {
        return _c("li", { key: index }, [
          _vm._v(_vm._s(_vm.options[index]) + " : " + _vm._s(item))
        ])
      })
    )
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2aca26d0", esExports)
  }
}

/***/ })
/******/ ]);
//# sourceMappingURL=cddh.js.map